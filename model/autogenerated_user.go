...
// nolint: dupl
func (qs UserQuerySet) CreatedAtIsNotNull() UserQuerySet {
	return qs.w(qs.db.Where("created_at IS NOT NULL"))
}

// CreatedAtIsNull is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) CreatedAtIsNull() UserQuerySet {
...
// PreloadProfile is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) PreloadProfile() UserQuerySet {
	return qs.w(qs.db.Preload("Profile"))
}

// RoleEq is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) RoleEq(role string) UserQuerySet {
	return qs.w(qs.db.Where("role = ?", role))
}

// RoleIn is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) RoleIn(role ...string) UserQuerySet {
	if len(role) == 0 {
...
// nolint: dupl
func (qs UserQuerySet) RoleNe(role string) UserQuerySet {
	return qs.w(qs.db.Where("role != ?", role))
}

// RoleNotIn is an autogenerated method
// nolint: dupl
func (qs UserQuerySet) RoleNotIn(role ...string) UserQuerySet {
	if len(role) == 0 {
...
// SetProfile is an autogenerated method
// nolint: dupl
func (u UserUpdater) SetProfile(profile Profile) UserUpdater {
	u.fields[string(UserDBSchema.Profile)] = profile
	return u
}

// SetRole is an autogenerated method
// nolint: dupl
func (u UserUpdater) SetRole(role string) UserUpdater {
...
var UserDBSchema = struct {
	...
	Profile:   UserDBSchemaField("profile"),
}
